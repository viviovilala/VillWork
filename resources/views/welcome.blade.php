    ...
    <header class="bg-gray-50">
        <div class="container mx-auto px-6 py-20 md:py-32 text-center">
            ...
            <p class="mt-4 text-lg md:text-xl text-gray-600 max-w-3xl mx-auto">
                Platform terpadu untuk menemukan lowongan kerja terbaik dan mengikuti pelatihan untuk meningkatkan
                keahlian Anda.
            </p>
            <div class="mt-8 flex justify-center gap-4">
                <a href="{{ route('register') }}"
                    class="bg-gray-800 text-white px-8 py-3 rounded-lg font-semibold hover:bg-gray-600 transition-transform hover:scale-105 shadow-lg">
                    Daftar Sekarang
                </a>
                <a href="#fitur"
                    class="bg-white text-gray-800 px-8 py-3 rounded-lg font-semibold hover:bg-gray-200 transition-transform hover:scale-105 border border-gray-200">
                    Lihat Fitur
                </a>
            </div>
        </div>
        ...
        <div class="container mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
                <div class="bg-gray-50 p-8 rounded-xl shadow-md hover:shadow-xl transition-shadow">
                    <div
                        class="bg-indigo-100 text-indigo-600 w-16 h-16 rounded-full flex items-center justify-center mb-6">
                        <i class="fa fa-briefcase fa-2x"></i>
                    </div>
                    <h3 class="text-2xl font-bold mb-3">Lowongan Kerja Terkurasi</h3>
                    <p class="text-gray-600">
                        Temukan ribuan lowongan dari perusahaan terpercaya yang sesuai dengan minat dan keahlian Anda.
                        Proses lamaran yang mudah dan cepat.
                    </p>
                </div>
                <div class="bg-gray-50 p-8 rounded-xl shadow-md hover:shadow-xl transition-shadow">
                    <div
                    ...
                    <p class="text-gray-600">
                        Tingkatkan kompetensi Anda dengan berbagai pilihan pelatihan online dari para ahli di bidangnya.
                        Dapatkan sertifikat untuk menunjang CV Anda.
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="bg-white p-6 rounded-lg shadow-sm text-center">
                    <img src="https://i.pravatar.cc/100?u=a" alt="User"
                        class="w-16 h-16 rounded-full mx-auto -mt-12 border-4 border-white">
                    <p class="mt-4 text-gray-600 italic">"Melalui VillWork, saya berhasil mendapatkan pekerjaan impian
                        saya hanya dalam 2 minggu. Platformnya sangat mudah digunakan!"</p>
                ...
                <div class="bg-white p-6 rounded-lg shadow-sm text-center">
                    <img src="https://i.pravatar.cc/100?u=b" alt="User"
                        class="w-16 h-16 rounded-full mx-auto -mt-12 border-4 border-white">
                    <p class="mt-4 text-gray-600 italic">"Pelatihan Digital Marketing di sini materinya sangat relevan
                        dengan industri saat ini. Sangat membantu untuk upgrade skill."</p>
                ...
                <div class="bg-white p-6 rounded-lg shadow-sm text-center">
                    <img src="https://i.pravatar.cc/100?u=c" alt="User"
                        class="w-16 h-16 rounded-full mx-auto -mt-12 border-4 border-white">
                    <p class="mt-4 text-gray-600 italic">"Sebagai recruiter, mencari talenta di VillWork lebih efisien.
                        Kandidat yang melamar sangat berkualitas."</p>
    ...
    <section class="bg-gray-800 text-white">
        <div class="container mx-auto px-6 py-20 text-center">
            ...
            <p class="mt-4 text-gray-300 max-w-2xl mx-auto">
                Bergabunglah dengan ribuan pengguna lainnya dan mulailah perjalanan karir Anda bersama VillWork hari
                ini.
            </p>
            <div class="mt-8">
                <a href="{{ route('register') }}"
                    class="bg-green-500 text-white px-8 py-3 rounded-lg font-semibold hover:bg-green-600 transition-transform hover:scale-105 shadow-lg">
                    Buat Akun Gratis
                </a>
            </div>
        </div>
