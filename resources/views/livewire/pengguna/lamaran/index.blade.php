        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-6 px-4 sm:px-0 flex flex-col md:flex-row justify-between items-center gap-4">
                ...
                <div class="w-full md:w-1/3 flex items-center gap-2">
                    <a href="lamaran/history" wire:navigate
                        class="flex-shrink-0 inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-700 active:bg-indigo-800 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
                        Riwayat Lamaran
                    </a>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                @forelse ($lowongans as $lowongan)
                    <div wire:key="{{ $lowongan->id }}"
                        ...
                        <div class="p-6 bg-gray-50 border-t border-gray-200 space-y-3">
                            <div class="flex items-center text-gray-600 text-sm"><i
                                    class='bx bxs-map mr-2 text-lg'></i><span>{{ $lowongan->lokasi }}</span></div>
                            <div class="flex items-center text-gray-600 text-sm"><i
                ...
                @empty
                    <div class="col-span-1 md:col-span-2 lg:col-span-3 text-center py-16">
                        <p class="text-gray-500">Tidak ada lowongan pekerjaan ditemukan.</p>
                    </div>
                @endforelse
            </div>
